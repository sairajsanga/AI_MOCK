...
Thank you!`);
    ...
    window.open(`mailto:sairajsanga459@gmail.com?subject=${subject}&body=${body}`);
  };
        ...
        <div className="text-center space-y-4">
          ...
          <Card className="bg-gray-50">
            <CardContent className="p-6 text-center">
              ...
              <a href="https://github.com/sairajsanga">
                <p className="text-sm text-gray-600 mb-4">Sairaj Sanga</p>
              </a>
